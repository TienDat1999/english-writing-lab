...
paraphraseExampleEn: MUST strictly follow and apply the EXACT sentence structure and keywords of patternTipVi, filling in the bracketed placeholders [...] with realistic content for a different topic so the learner sees how to transfer the structure. Do NOT change the template's fixed wording.`,
          ...
          "vocabularyUpgrades rules: ONLY suggest genuine lexical/vocabulary upgrades (e.g. replacing basic A2/B1 words with advanced B2/C1 academic vocabulary, such as 'important' -> 'crucial / pivotal', 'good' -> 'beneficial', 'show' -> 'demonstrate / illustrate', 'convincing' -> 'compelling / persuasive'). CRITICAL: NEVER include spelling mistakes (like 'convice', 'leason'), typos, or basic grammar fixes (like 'base on' -> 'based on') in vocabularyUpgrades! All spelling and grammar corrections must go into grammarIssues only. Return an empty vocabularyUpgrades array if there are no genuine advanced academic vocabulary upgrades.",
